...
I recently was invited to be a speaker at the [Bevy Meetup](https://www.meetup.com/bevy-game-development/), sponsored by [Rustunit](https://rustunit.com/). The recording is now availble, and you may find extra material below. _Thank you to <https://rustunit.com/>_.
...
- [Slides (download .pdf)]({{ '/assets/Compute-centric-vector-graphics-with-bevy_vello.pdf' | relative_url }})
- [Slides (download .pptx)]({{ '/assets/Compute-centric-vector-graphics-with-bevy_vello.pptx' | relative_url }})
