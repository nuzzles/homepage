...
![NSight Systems]({{ '/assets/NSight_Systems_Example.png' | relative_url }})
...
![NSight Annotations]({{ '/assets/NVTX_Example.png' | relative_url }})
...
![NSight Marker]({{ '/assets/Marker_Example.png' | relative_url }})
...
Ranges are pushed with the `range_push!` macro, and popped with the `range_pop!` macro. Thread ranges are also safe to push and pop over thread boundaries, hence _thread_ in the name.
...
![NVTX Thread Range]({{ '/assets/Range_Example.png' | relative_url }})
...
![NVTX Thread Naming]({{ '/assets/Thread_Example.png' | relative_url }})
...
![Sample Images]({{ '/assets/renderkit.svg' | relative_url }})
...
![Sample Images]({{ '/assets/all_images.svg' | relative_url }})

### Results

The benchmark was simple: render 50 frames and record how long each frame took. The results are plotted below.

![My Results]({{ '/assets/all_renderkit.svg' | relative_url }})

Tessellation-time was not plotted here, and no frame was rendered any differently. So to my surprise, why was the first frame taking longer? Using the power of NVTX annotations, I dropped some tracers to understand the instructions temporally. I annotated the first frame as "_Strange Behavior_".

![NVTX Tracers]({{ '/assets/NVTX_Trace.png' | relative_url }})
